...
if ($_GET['acao']=='listar') {
    ...
    while($row = $res->fetch_assoc()) {
        ...
        echo "<td>
        <button class='btn btn-info btn-xs btn-editar carrossel-acao' data-id='{$row['id']}'>Editar</button>
        <button class='btn btn-danger btn-xs btn-excluir carrossel-acao' data-id='{$row['id']}'>Excluir</button>
        </td>";
        echo "</tr>";
    }
    exit;
...
if ($_GET['acao']=='form_editar') {
    ...
    ?>
    <div class="modal fade" id="modalEditarCarrossel" tabindex="-1">
